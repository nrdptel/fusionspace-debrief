                  ...
                  {flights.length > 1 && (
                    <span className="mb-0.5 flex items-center justify-end gap-0.5 print:hidden">
                      ...
                      <button
                        ...
                        title="Move left"
                        className="flex h-6 w-6 items-center justify-center rounded-md text-zinc-500 transition enabled:hover:bg-zinc-100 enabled:hover:text-zinc-700 dark:text-zinc-400 disabled:opacity-30 dark:enabled:hover:bg-zinc-800 dark:enabled:hover:text-zinc-200"
                      >
                        ◀
                      </button>
                      <button
