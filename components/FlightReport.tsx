              ...
              <button
                ...
                className={`rounded-md border px-2 py-0.5 text-xs font-medium transition ${
                  active
                    ...
                    : 'border-zinc-500 bg-white text-zinc-700 hover:border-indigo-600 hover:text-indigo-600 dark:border-zinc-500 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:border-indigo-500/60 dark:hover:text-indigo-400'
                }`}
              >
                {p.label}
              </button>
