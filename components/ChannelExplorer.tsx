        ...
        {naming ? (
          <span className="inline-flex items-center gap-1">
            <input
              ...
              className="min-h-[1.75rem] w-36 rounded-md border border-zinc-500 bg-white px-2 py-0.5 text-sm text-zinc-800 placeholder:text-zinc-500 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:border-zinc-500 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-400"
            />
