...
function analysis(t0: number, apogee: number): FlightAnalysis {
  ...
  return {
    series: { time, altitude, altitudeRaw: altitude, velocity, acceleration: new Float64Array(5), velocitySource: 'baro', accelerationSource: 'baro', speedOfSound: 340, airDensity: new Float64Array(5).fill(1.225) },
